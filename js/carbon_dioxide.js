export function carbon_dioxide(data) {
    ...
    // 定义线条生成器，我们使用的是 date 和 monthly_average
    var line = d3.line()
        .x(function (d) { return x(d.date); })
        .y(function (d) { return y(d.monthly_average); });
    ...
    data.forEach(function (d) {
        ...
        d.monthly_average = +d.monthly_average;
    });

    // 设置 X 和 Y 轴的域
    x.domain(d3.extent(data, function (d) { return d.date; }));
    y.domain(d3.extent(data, function (d) { return d.monthly_average; }));
